...
public class GSYOAuthServerConfiguration extends AuthorizationServerConfigurerAdapter {
     ...
     */
    @Autowired
    public GSYOAuthServerConfiguration(AuthenticationManager authenticationManagerBean) {
